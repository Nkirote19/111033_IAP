    ...
    <aside class="page-sidebar"  style="width:20%!important;">
        ...
        <nav id="js-primary-nav" class="primary-nav" role="navigation">
            ...
            <div class="info-card">
                <img  src="<?php echo e(URL::asset('img/demo/avatars/avatar-h.png')); ?>"class="profile-image rounded-circle"alt="Administartor">
                ...
                <img src="<?php echo e(URL::asset('img/card-backgrounds/cover-1-lg.png')); ?>" class="cover"alt="cover">
                    ...
                    <ul>
                        <li>
                            ...
                            <ul>
                                ...
                                <li class="">
                                    <a href="<?php echo e(url('all_students')); ?>" >
            ...
            <div class="filter-message js-filter-message bg-success-600"></div>
                ...
                <!-- END Left Aside --><?php /**PATH C:\xampp\htdocs\111033_IAP\resources\views/111033/templates/edit-nav.blade.php ENDPATH**/ ?>