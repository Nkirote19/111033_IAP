                    ...
                    <header class="page-header" role="banner" style="margin-left: 20%!important;">
                        ...
                        <div class="page-logo">
                            <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
                                <img src="{{ URL::asset('img/backgrounds/clouds.png') }}" alt="SkyHigh Aviation" aria-roledescription="logo">
                        ...
                        @yield('student_breadcrumbs')
                        @yield('fees_breadcrumbs')
                        @yield('all_breadcrumbs')
                        @yield('all_payments_breadcrumbs')
                        @yield('edit_breadcrumbs')
