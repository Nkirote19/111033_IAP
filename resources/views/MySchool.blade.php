...
<html lang="en">
    <head>
        ...
        <link id="vendorsbundle" media="screen, print" href="{{ asset('css/vendors.bundle.css') }}" rel="stylesheet">
        <link id="appbundle" media="screen, print" href="{{ asset('css/app.bundle.css') }}" rel="stylesheet">
        <link id="mytheme" rel="stylesheet" media="screen, print" href="#">
        <link id="myskin" media="screen, print" href="{{ asset('css/skins/skin-master.css') }}" rel="stylesheet">

         <link rel="icon" href="{{ URL::asset('img/plane.png') }}"sizes="180x180" />
        <link rel="icon" href="{{ URL::asset('img/plane.png') }}" type="image/png"sizes="32x32"/>
        <link rel="mask-icon" href="{{ URL::asset('img/favicon/safari-pinned-tab.svg') }}" color="#5bbad5" />
        <link id="myskin" media="screen, print" href="{{ asset('css/page-login-alt.css') }}" rel="stylesheet">
        <style >
            .heading{
    ...
    <body>
        <div class="col-11">
            <div class="content-div">
                <div>
                    <img class="img" src="{{ URL::asset('img/plane.png') }}">
                    ...
                    <div class="row" style="margin-left: 32%!important;">
                        <button type="button" class="btn btn-sm btn-outline-primary col-3 btn-pills waves-effect waves-themed" style="border-radius: 25px;" onclick="window.location='{{ url('student') }}'">
                            <h4 style="padding-top: 8px!important;"><i class="fal fa-users"></i> STUDENTS</h4>
                        </button>

                        <button style="border-radius: 25px;margin-left: 7px!important;"type="button" onclick="window.location='{{ url('fees') }}'" class="btn btn-outline-primary col-3 btn-pills waves-effect waves-themed"> 
